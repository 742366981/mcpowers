...
description: |
  Python 爬虫项目开发专项技能。当用户说"爬虫项目"、"爬虫开发"、"抓取数据"、"数据采集"、"继续爬虫"时自动触发。

  **触发场景**：
  - 爬虫项目 / 爬虫开发 / 抓取数据 / 数据采集
  - 继续爬虫项目 / 继续爬虫开发 / 爬虫继续开发
  - 爬虫 / 抓取 / 继续抓取
...
检查 `docs/细节记录/` 目录，汇报与本次开发相关的内容：

```
### 细节记录检查
| 文件 | 内容摘要 | 本次是否涉及 |
|:-----|:---------|:------------|
| xxx.md | xxx功能的关键实现点 | ✅ 涉及 |
| - | 无相关记录 | - |
...
def xxx_callback_success(result, extra):
    ...
    data = {'task_id': extra['id'], 'result': result}
