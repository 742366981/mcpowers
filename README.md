...
3. `CLAUDE.md` 和 `README.md` 同步更新 Hook 事件组/脚本清单及维护说明（v4.3.0+ 累计 11 个脚本 / 5 个事件组；v4.5.0+ 接口契约四铁律 ERROR 硬门禁加入清单）
