...
| **爬虫（项目骨架）** | `爬虫规范.md` |
| **爬虫接口分析 / 逆向 / 加密参数还原** | `爬虫分析规范.md`（v2.9.5 接管 SOP §2.5.1-2.5.4 + 弹窗 §2.7 + 协作模式 §3.0 + 置信度 §3.4.5 + 附录 D 弹窗字典；v2.11.1 追加 §2.5.5.0 安装 + §2.5.5.1 daemon 实操 + §3.0.5 adapter 失败判定与结果合并） |
